    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((authz) -> authz
                        ...
                        .requestMatchers( "/level").hasAnyRole("USER", "ADMIN")
                        .requestMatchers( "/level/**").hasAnyRole("USER", "ADMIN")
                        .requestMatchers("/", "/greeting", "/logout", "/score","/score/**","/totalscore/**").permitAll()
                        .requestMatchers( "/check-answer").hasAnyRole("USER", "ADMIN")
                        .requestMatchers( "/check-answer/**").hasAnyRole("USER", "ADMIN")
                        .requestMatchers("/", "/logout", "/current-user", "/car", "/car/**").permitAll()
